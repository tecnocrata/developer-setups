# Dism.exe /online /Enable-Feature /FeatureName:IIS-WebServerRole /FeatureName:IIS-WebServerRole 
# /FeatureName:IIS-WebServer /FeatureName:IIS-ApplicationDevelopment 
# /FeatureName:IIS-Security /FeatureName:IIS-RequestFiltering 
# /FeatureName:IIS-NetFxExtensibility /FeatureName:WAS-WindowsActivationService 
# /FeatureName:WAS-ProcessModel /FeatureName:WAS-NetFxEnvironment 
# /FeatureName:WAS-ConfigurationAPI /FeatureName:NetFx3 /FeatureName:WCF-HTTP-Activation 
