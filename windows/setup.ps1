...
# NOT sure about these ones: DisableAdminShares
...
Function InstallSqlServer {
    Write-Host -ForegroundColor 'Green' 'Installing SQL Server...'
    $SqlInstance = 'MSSQLSERVER'
    $QuietSimple = $true
    $x86 = $false
    $InstanceName = 'MSSQLSERVER' # SqlExpress
    $Pass = 'P@$$w0rd'
...
"@
    ...
    choco install sql-server-2016-developer-edition --execution-timeout 5400 --ia "/ConfigurationFile='c:\ConfigurationFile.ini'" -y
...
Add-LocalGroupMember -Group "Administrators" -Member "UCN\_rdbuild"

Set-DnsClientGlobalSetting -SuffixSearchList @("ucn.net", "in.lab", "inucn.com", "ineur.eu", "dradev.lab", "link.net", "ucnlabext.com")

New-Item -Path "c:\" -Name "uploads" -ItemType "directory"
New-Item -ItemType "directory" -Path "c:\Proj\LogFiles"
New-Item -ItemType "directory" -Path "c:\Proj\InstallLogs"
New-Item -ItemType "directory" -Path "c:\Proj\InDataDBInstaller"

[System.Environment]::SetEnvironmentVariable('LOGPATH','c:\Proj\LogFiles',[System.EnvironmentVariableTarget]::Machine)
